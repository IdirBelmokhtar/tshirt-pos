            ...
            <form action="{{ route('login') }}" method="post" class="authentication-form px-lg-5 needs-validation"
                ...
                <div class="authentication-form-header">
                    <a href="{{ route('frontend.home') }}" class="logo">
                        <img src="{{ assetImage(readconfig('site_logo')) }}" width="200px" alt="logo de la marque">
                    </a>
                    <h3 class="form-title">Connexion</h3>
                    <p class="form-des">Bon retour ! Connectez-vous pour accéder à votre compte.</p>
                </div>
                                ...
                                <div class="agreebox">
                                    <div class="customcheck ">
                                        <input type="checkbox" id="agree" class="customcheck-box" name="remember"
                                            hidden>
                                        <label for="agree" class="customcheck-label">J'accepte les <a
                                                href="#">Conditions </a> et la <a href="">Politique de confidentialité</a>
                                            .</label>
                                    </div>
                                </div>
                            </div> --}}
